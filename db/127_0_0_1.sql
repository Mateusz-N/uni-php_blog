...
--
-- Host: 127.0.0.1
-- Czas generowania: 07 Gru 2022, 12:51
...
ALTER TABLE `comment`
  ...
  ADD KEY `FK_article_comment` (`article_id`),
  ADD KEY `FK_author_comment` (`author_id`) USING BTREE;
...
--
ALTER TABLE `article`
  ADD CONSTRAINT `FK_author_article` FOREIGN KEY (`author_id`) REFERENCES `author` (`author_id`);

--
-- Ograniczenia dla tabeli `comment`
--
ALTER TABLE `comment`
  ADD CONSTRAINT `FK_article_comment` FOREIGN KEY (`article_id`) REFERENCES `article` (`article_id`),
  ADD CONSTRAINT `FK_author_comment` FOREIGN KEY (`author_id`) REFERENCES `author` (`author_id`);
--
...
('root', '[{\"db\":\"blog\",\"table\":\"article\"},{\"db\":\"blog\",\"table\":\"comment\"},{\"db\":\"blog\",\"table\":\"author\"},{\"db\":\"blog\",\"table\":\"user\"},{\"db\":\"phpmyadmin\",\"table\":\"pma__usergroups\"},{\"db\":\"phpmyadmin\",\"table\":\"pma__users\"}]');
...
('root', '2022-12-07 11:50:43', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pl\"}');
